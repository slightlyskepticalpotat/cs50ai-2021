...
# everyone has to be knight or knave but not both
common_sense = And(
    Or(AKnight, AKnave),
...
knowledge2 = And(
    ...
    common_sense,
    # if they are the same, A is a knight and vice versa
    Biconditional(AKnight, Or(And(AKnight, BKnight), And(AKnave, BKnave))),
    # otherwise A must be a knave and vice versa
    Biconditional(AKnave, Not(Or(And(AKnight, BKnight), And(AKnave, BKnave)))),
    # if they are different, B is a knight and vice versa
    Biconditional(BKnight, Or(And(AKnight, BKnave), And(AKnave, BKnight))),
    # otherwise B must be a knave and vice versa
